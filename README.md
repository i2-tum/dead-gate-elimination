# Update 29.11.2025: quick working implementation helped by AI
With the help of GPT, a quick version of dead-gate elimination that could work is now available in file `dead-gate-elimination.py`.
A quick version of the host-side static analysis is also implemented and could be found at `host-side-static-analysis.py`, the discussion of which, however, is detailed in a manuscript under double-blind review. 
There are chunks of code generated by AI, which are yet waiting to be carefully checked. New updates will come if the checks are done.

# demo-dead-gate-elimination
A demonstration that the idea of dead gate elimination works.
The manuscript is accessible at [Dead Gate Elimination](https://link.springer.com/chapter/10.1007/978-3-031-97632-2_10).
